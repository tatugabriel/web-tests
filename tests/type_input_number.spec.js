...
(async function typeInInput() {
    try {
        ...
        // Type the number into the input box
        const numberToType = '12345';
        await inputBox.sendKeys(numberToType);
        console.log(`Typed the number ${numberToType} into the input box.`);
        ...
        assert.strictEqual(inputValue, numberToType, `Verification failed: Expected ${numberToType}, but got ${inputValue}`);

        // If the test passes
        console.log("Verification successful: The number was typed correctly.");
